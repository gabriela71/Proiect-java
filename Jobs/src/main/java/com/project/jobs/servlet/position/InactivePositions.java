...
@WebServlet(name = "InactivePositions", urlPatterns = {"/InactivePositions"})
public class InactivePositions extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        positionBean.setAsteptare(positionId,true);
        
        response.sendRedirect(request.getContextPath()+"/InactivePositions");

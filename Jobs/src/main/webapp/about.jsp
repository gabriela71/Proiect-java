...
<t:pageTemplate pageTitle="About Jobs Recruiting">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    ...
                    <hr class="divider my-4">
                        <p class="text-muted mb-5">Ready to start your next job with us? Give us a call or send us an email and we will get back to you as soon as possible!</p>
                </div>
            </div>
            <div class="row">
    ...
    <footer class="bg-light py-5">
        <div class="container"><div class="small text-center text-muted">Copyright © Jobs 2021</div></div>
    </footer>
</t:pageTemplate>
            ...
            <div class="col-md-12 ">
                <div class="card flex-md-row mb-4 box-shadow h-md-250 ">
                    <div class="card-body d-flex flex-column align-items-start text-truncate">
                        ...
                        <a class="btn btn-dark btn-lg btn-block" href="${pageContext.request.contextPath}/Position/Update?id=${position.id}&pagina=InactivePositions" role="button">Edit Position</a>                                               
                        <button class="btn btn-primary btn-lg btn-block" type="submit" name="position_id" value="${position.id}">Deschide pozitie</button>                                                                                                                  
                    </div>                                      
                </div>
            </div>            
            </div>                       

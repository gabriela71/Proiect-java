...
<t:pageTemplate pageTitle="About Jobs Recruiting">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <h2 class="mt-0"><fmt:message key="aboutMessage1"/></h2>
                    <hr class="divider my-4">
                        <p class="text-muted mb-5"><fmt:message key="aboutMessage"/></p>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4 mr-auto text-center">
                    ...
                    <a class="d-block" href="mailto:contact@yourwebsite.com">jobsrecruiting.project@gmail.com</a>
                </div>
            </div>
        </div>
    </section>
    <footer class="bg-light py-5">
        <div class="container"><div class="small text-center text-muted"><fmt:message key="copyright"/> © <fmt:message key="jobs"/> 2021</div></div>
    </footer>
</t:pageTemplate>